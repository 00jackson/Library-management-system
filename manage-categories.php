                ...
                <div class="header-line">
                        <p style=" background-image: url('assets/img/ag.jpg');
                                   background-repeat: repeat;
                                    ...
                                    font-weight: 800;
                                    -webkit-font-smoothing: antialiased;" >MANAGE CATAGORY</p>
                    </div>
    </div>
     <div class="row">
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <a href="edit-category.php?catid=<?php echo htmlentities($result->id);?>"><button class="btn btn-primary" style="margin-bottom: 4px;"><i class="fa fa-edit "></i> Edit</button> 
                                          <a href="manage-categories.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Are you sure you want to delete?');" >  <button class="btn btn-danger" style="margin-bottom: 4px;"><i class="fa fa-trash"></i> Delete</button>
                                            </td>
                                        </tr>
                                        <?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
