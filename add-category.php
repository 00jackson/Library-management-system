                        ...
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <li>
                                ...
                                <ul class="dropdown-menu dropp" role="menu" aria-labelledby="ddlmenuItem">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="add-category.php" class="menu-top-active">Add Category</a></li>
                ...
                <div class="header-line">
                        <p style=" background-image: url('assets/img/ag.jpg');
                                   background-repeat: repeat;
                                    ...
                                    font-weight: 800;
                                    -webkit-font-smoothing: antialiased;" >ADD CATAGORIES</p>
                    </div>
...
<input class="inpt" type="text" name="category" autocomplete="off" required />
</div>
<div class="form-group">
<label>Status</label>
...
<button type="submit" name="create" class="subbtn">Create </button>
